 ...
 */
final class Version20200816201505 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE promo DROP archived');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE promo ADD archived TINYINT(1) NOT NULL');
